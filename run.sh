...
SAVE_PATH="/mnt/parscratch/users/elq20xd/channel_estimation/save_models/fixed_UEs_15GHz_ReduceLR/valid_Dataset_dB-15_N36_K4_L4_S9_Setup20_Reliz1000Ran1_"
# SAVE_PATH="${SAVE_PATH}flatCE_l1c32dia4"
SAVE_PATH="${SAVE_PATH}attenCExd_dev"
