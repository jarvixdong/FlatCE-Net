...
MSE_MMSE_avg = 0;
H_norm_avg = 0;
setup_num = 101; % In each setup, user locations are randomly generated
...
train_data_path = strcat(dir_path, 'train','_Dataset_dB', num2str(Pt_dB), '_N', num2str(N), '_K', num2str(K), '_Setup', num2str(setup_num), '_Reliz', num2str(realization_num), '.mat');
valid_data_path = strcat(dir_path, 'valid','_Dataset_dB', num2str(Pt_dB), '_N', num2str(N), '_K', num2str(K), '_Setup', num2str(setup_num), '_Reliz', num2str(realization_num), '.mat');
