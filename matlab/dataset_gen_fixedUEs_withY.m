...
Pt_dB = 0; % Transmit power: 10 dBm (-20 dB)
...
ran=1;
ran_num = N*L*S*ran % Number of random phase shift vectors
% ran_num = 1
...
V_pinv_LS_all_train = zeros(N,S*M,train_setup_num*train_reliz);

dir_path = '/mnt/parscratch/users/elq20xd/channel_estimation/cc_data/fixed_UEs_15GHz_withY/';
...
V_pinv_LS_all_test = zeros(N,S*M,test_setup_num*test_reliz);
...
train_suffix = strcat('train_Dataset_dB', num2str(Pt_dB), '_N', num2str(N), '_K', num2str(K), ...
                      ...
                      '_Reliz', num2str(train_reliz), 'Ran',num2str(ran),'.mat');
...
valid_suffix = strcat('valid_Dataset_dB', num2str(Pt_dB), '_N', num2str(N), '_K', num2str(K), ...
                      ...
                      '_Reliz', num2str(valid_reliz), 'Ran',num2str(ran),'.mat');
...
test_suffix = strcat('test_Dataset_dB', num2str(Pt_dB), '_N', num2str(N), '_K', num2str(K), ...
                     ...
                     '_Reliz', num2str(test_reliz), 'Ran',num2str(ran),'.mat');
