...
# 保存为 PNG 和 EPS
plt.tight_layout()
plt.savefig(os.path.join(output_folder, 'SIM_performance_comparison.png'), dpi=300)
# plt.savefig(os.path.join(output_folder, 'performance_comparison.eps'), format='eps')
plt.savefig(os.path.join(output_folder, 'SIM_performance_comparison.pdf'), format='pdf')
